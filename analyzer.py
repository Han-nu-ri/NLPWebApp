...
class SentimentAnalyzer():
    ...
    def predict(self, predict_sentence, max_len=64, batch_size=64):
        ...
        test_dataloader = torch.utils.data.DataLoader(test_BERT_X, batch_size=batch_size, num_workers=2)
...
if __name__ == "__main__":
    ...
    test_result = sentiment_analyzer.predict(predict_sentence=["test"])[0]
    print(test_result)